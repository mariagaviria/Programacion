...
with open('coordenadas-CRI.csv')as File:
...
def funcri():
    ...
    expn=exp-imp
    canvas.create_text(coordenadas['CRI'][0], 563, text=('Exportacion= ',exp, ' de dolares'), font=('Times New Roman',10))
    canvas.create_text(coordenadas['CRI'][0], 598, text=('Importacion= ',imp,' de dolares'), font=('Times New Roman',10))
    canvas.create_text(coordenadas['CRI'][0], 633, text=('Exportacion neta= ',expn,' de dolares'), font=('Times New Roman',10))
