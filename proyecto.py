...
''' Las librerias que importamos fueron tkinter para  poder crear ventanas y dibujar sobre ellas, csv para poder leer archivos de este formato, y el resto son archivos donde hay una funcion a la cual accederemos despues. '''
...
'''Abrimos el archivo llamado coordenadas y creamos un diccionario con la informacion que contiene este.  '''
...
'''Aquí hicimos algo similar con el archivo anterior, la diferencia es que en este se creo un diccionario con diccionarios adentro.  '''
...
'''Aquí definimos la funcionalidad que tendran los botonoes, los cuales crearemos más adelante. Como pueden ver, se están llamando las funciones que vienen de los tros archivos que se importaron.  '''
...
def sketch():
    ...
    '''Creamos los botones y con el parametro 'command' le dimos la funcionalidad a ese boton en específico. Para que apareciera el boton,, se creo una ventana cuya función será la de un boton.''' 
