...
with open('coordenadas-GTM.csv')as File:
...
def fungtm():
    ...
    expn=exp-imp
    canvas.create_text(coordenadas['GTM'][0], 563, text=('Exportacion= ',exp, ' de dolares'), font=('Times New Roman',10))
    canvas.create_text(coordenadas['GTM'][0], 598, text=('Importacion= ',imp,' de dolares'), font=('Times New Roman',10))
    canvas.create_text(coordenadas['GTM'][0], 633, text=('Exportacion neta= ',expn,' de dolares'), font=('Times New Roman',10))